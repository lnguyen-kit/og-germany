...
def main():
    ...
    base_dir = os.path.join(CUR_DIR, "OG-Germany-run_baseline2", "OUTPUT_BASELINE")
    reform_dir = os.path.join(CUR_DIR, "OG-Germany-run_baseline2", "OUTPUT_REFORM")
    ...
    print("baseline run time start ohne Timepath ")
    ...
    print("baseline run time Ende ohne Timepath ")
    ...
    op.plot_all(
        base_dir, reform_dir, os.path.join(CUR_DIR, "OG-Germany_run_baseline_plots")
    )
    '''
    op.plot_aggregates(
        base_tpi,
        ...
        var_list=["Y", "C", "K", "L", "r", "w"],
        plot_type="levels",
        path=os.path.join(CUR_DIR, "OG-Germany_example_plots"),
    )
    '''
    ...
    ans.to_csv("ogdeu_example_output_baseline_only.csv")
