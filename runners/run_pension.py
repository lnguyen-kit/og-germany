...
def main():
    ...
    base_dir = os.path.join(CUR_DIR, "OG-Germany-baseline-p", "OUTPUT_BASELINE")
    reform_dir = os.path.join(CUR_DIR, "OG-Germany-baseline-p", "OUTPUT_REFORM")
    ...
    op.plot_all(
        base_dir, reform_dir, os.path.join(CUR_DIR, "OG-Germany_baseline_plots")
    )

    print("Percentage changes in aggregates:", ans)
    # save percentage change output to csv file
    #ans.to_csv("ogdeu_example_output.csv")
    ans.to_csv("ogdeu_example_output_pension.csv")
