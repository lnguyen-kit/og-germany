...
def main():
    ...
    base_dir = os.path.join(CUR_DIR, "OG-Germany-Example2", "OUTPUT_BASELINE")
    reform_dir = os.path.join(CUR_DIR, "OG-Germany-Example2", "OUTPUT_REFORM")
    ...
    ans.to_csv("ogdeu_example_output1.csv")
